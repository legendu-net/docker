# [dclong/jupyterhub-selenium-firefox](https://hub.docker.com/r/dclong/jupyterhub-selenium-firefox/)
...
```
docker run -d \
    --name jupyterhub-selenium-firefox \
    ...
    dclong/jupyterhub-selenium-firefox
```
