# dclong/jupyterhub-beakerx [@DockerHub](https://hub.docker.com/r/dclong/jupyterhub-beakerx/) | [@GitHub](https://github.com/legendu-net/docker/tree/dev/docker-jupyterhub-beakerx)
